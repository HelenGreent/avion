      ...
      <div class="footer-top">
        <div class="footer-menu">
          ...
          <div>
            ...
            <router-link
              :to="{ name: $routeNames.productList, params: { type: 'crockery' } }"
              class="menu__link"
            >
              Crockery
            </router-link>
            <router-link
              :to="{ name: $routeNames.productList, params: { type: 'tables' } }"
              class="menu__link"
            >
              Tables
            </router-link>
            <router-link
              :to="{ name: $routeNames.productList, params: { type: 'plant-pots' } }"
              class="menu__link"
            >
              Plant pots
            </router-link>
            <router-link
              :to="{ name: $routeNames.productList, params: { type: 'chairs' } }"
              class="menu__link"
            >
              Chairs
            </router-link>
